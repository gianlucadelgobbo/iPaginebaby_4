$(document).ready(function (){
    ...
    if(cookie_platform){
        switch (cookie_platform){
            ...
            case "websearch":
                $("img."+current_platform).hide();
                $("img.WebSearch").show();
                $("#intro-iphone").attr("class","WebSearch");
                $("#whats-iphone").attr("class","WebSearch");
                $("#second-btn").text("iPhone");
                $("#third-btn").text("Android");
                $(".slide .WebSearch-slide").show();
                current_platform = "WebSearch";
            break;
            default:
        ...
        switch(current_platform){
            case "Android":
                ...
                $("#intro .titles a.WebSearch").hide();
                $("#intro .titles a.Android").show();
            break;

            case "WebSearch":
                $("#intro .titles a.iPad").hide();
                $("#intro .titles a.WebSearch").show();
    ...
    images = new Array(
        ...
        template_path+"/img/websearch.png",
        ...
        template_path+"/img/websearch-whats.png",
    ...
    $(".platform a").click(function(e){
        ...
        if(active_buttons){
            ...
            selected_dom = $(this);
            selected_platform = clearWebSearchPhoneText(selected_dom.text());
            ...
            $(platform_list).fadeOut("slow",function(){
                selected_dom.text(attachWebSearchPhoneText(old_platform));
            ...
            $("#intro .titles a.ir").animate({opacity:0},500,function(){
                ...
                switch(current_platform){
                    ...
                    case "WebSearch":
                        ...
                        $("#intro .titles a.WebSearch").show();
                        $("#intro .titles a.iPad").hide();
                        $("#intro .titles a.WebSearch").animate({opacity:1});
                    break;
...
//WebSearch text fix 
function clearWebSearchPhoneText(theText){ 
    if (theText == "Web Search") {
        return "Web Search";
    }else{  
        return theText;
    }
...
function attachWebSearchPhoneText(theText){  
    if (theText == "Web Search") {
        return "Web Search";
    }else{  
        return theText;
